...
// Products are populated live from the backend API
let PESTICIDES = [];
...
// Unified Basket Click Handler for desktop (#cartTrigger) & mobile
...
window.submitStorefrontRegister = async function(e) {
  ...
  try {
    ...
    if (loginIdentifier) loginIdentifier.value = phone;
